...
public class WriteMemoryStream
{
    ...
    public WriteMemoryStream()
    {
        ...
        _size = sizeof(Int16); // 앞에 2바이트는 버퍼 크기를 기록함
    }
    ...
    public byte[] GetValidBuffer()
    {
        ...
        Array.Copy(BitConverter.GetBytes(_size), 0, _buffer, 0, sizeof(Int16));
        Array.Copy(_buffer, 0, retBuffer, 0, _size); // 버퍼 사이즈 기록
        return retBuffer;
    }
    ...
    public void WriteByObject(IConvertBytes convertBytes)
    {
        convertBytes.ToBytes(this);
    }
